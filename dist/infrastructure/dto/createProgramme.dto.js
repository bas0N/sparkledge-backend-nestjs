...
exports.CreateProgrammeDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class CreateProgrammeDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, facultyId: { required: true, type: () => Number }, universityId: { required: true, type: () => Number } };
    }
}
__decorate([
...
], CreateProgrammeDto.prototype, "facultyId", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Number)
